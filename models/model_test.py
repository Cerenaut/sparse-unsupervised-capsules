...
class ModelTest(tf.test.TestCase):
    ...
    def testSingleTower_MultipleCalls(self):
        """Checks the correct variable size after multiple single_tower calls.
          ...
          Multiple towers should not declare multiple variables and should
          share the trainable variables. Therefore, variable set size should
          stay at 1.
    ...
    def testMultiGpu(self):
        ...
        Since tests don't have GPU access, test only covers the correct number
        of elements in the result lists.
        """
        with tf.Graph().as_default():
            test_model = self.MockModelWithVariable(self.hparams)
            feature = {
