...
class Model(object):
    ...
    def inference(self, features):
        ...
        features. The inference graph defined here should involve trainable
        variables otherwise the optimizer will raise a ValueError.

        Args:
          features: Dictionary of batched feature tensors like images and
            labels.
        Returns:
          An Inferred named tuple for expected outputs of the model like
    ...
    def _single_tower(self, tower_ind, feature):
        ...
        gradients based on the loss. Appends all the output values of this
        tower to their respective lists.
        ...
        Returns:
          A namedtuple TowerResult containing the inferred values like logits
          and reconstructions, gradients and evaluation metrics.
        """
    ...
    def _average_gradients(self, tower_grads):
        ...
        Args:
          tower_grads: List of gradient lists for each tower. Each gradient
            list is a list of (gradient, variable) tuples for all variables.
        Returns:
    ...
    def _summarize_towers(self, almosts, corrects, tower_grads, inferred):
        ...
        Returns:
          A JoinedResult of evaluation results, the train op and the summary
            op.
        """
        ...
        boosting_op = layers.boosting_op(
            self._hparams.num_latent_capsules,
            self._hparams.target_min_freq,
            self._hparams.target_max_freq,
            self._hparams.boost_factor,
            self._hparams.verbose)
        ...
        return JoinedResult(summary, train_op, boosting_op,
                            summed_corrects, summed_almosts, inferred)
    ...
    def multi_gpu(self, features, num_gpus):
        ...
        summarized_results = self._summarize_towers(
            almosts, corrects, tower_grads, inferred)
